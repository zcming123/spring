...
public class IoCTest {
    ...
    public void testFactoryBean() {
        ...
        System.out.println("获取CompanyFactoryBean产⽣的对象: " + companyBean);

        Object companyBean1 = applicationContext.getBean("&companyBean");
        System.out.println("获取CompanyFactoryBean: " + companyBean1);
    }
